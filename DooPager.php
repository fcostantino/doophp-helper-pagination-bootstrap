...
class DooPager{
     ...
     * @var string
     */
    public $currentCss = 'currentpager';
...
.paginate, .currentpager, .inactivePrev, .inactiveNext, .prev, .next {
...
.inactivePrev, .inactiveNext{
    ...
    public function paginate($page, $itemPerPage=0){
        ...
        if($this->_noNextPrev)
            $this->components['prev_link'] = ($this->currentPage != 1 && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->prevCss}\"><a  href=\"{$this->baseUrl}/{$prev_page}\">{$this->prevText}</a></li> ":"<li class=\"{$this->inactivePrevCss}\"><a >{$this->prevText}</a></li> ";
        else
            $this->output .= ($this->currentPage != 1 && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->prevCss}\" ><a href=\"{$this->baseUrl}/{$prev_page}\">{$this->prevText}</a></li> ":"<li class=\"{$this->inactivePrevCss}\"><a >{$this->prevText}</a></li> ";
        ...
        if($this->totalPage > $this->maxLength){
            ...
            for($i=1;$i<=$this->totalPage;$i++){
                ...
                if($i==1 || $i==$this->totalPage || in_array($i,$range)){
                    ...
                    $this->output .= ($i == $this->currentPage) ? "<li class =\"{$this->currentCss}\" ><a href=\"javascript:void(0);\">$i":"<li class=\"{$this->pagesCss}\"  ><a href=\"{$this->baseUrl}/$i\">$lastDot $i";
            ...
            if($this->_noNextPrev)
                $this->components['next_link'] = ($this->currentPage != $this->totalPage && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->nextCss}\" ><a href=\"{$this->baseUrl}/$next_page\">{$this->nextText}</a></li>\n" : "<li class=\"{$this->inactiveNextCss}\">{$this->nextText}</li>\n";
            else
                $this->output .= ($this->currentPage != $this->totalPage && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->nextCss}\"><a  href=\"{$this->baseUrl}/$next_page\">{$this->nextText}</a>\n" : "<li class=\"{$this->inactiveNextCss}\"><a >{$this->nextText}</a></li>\n";
        }
        else{
            for($i=1;$i<=$this->totalPage;$i++){
                $this->output .= ($i == $this->currentPage) ? "<li class=\"{$this->currentCss}\" ><a href=\"javascript:void(0);\">$i</a></li> ":"<li class=\"{$this->pagesCss}\"><a  href=\"{$this->baseUrl}/$i\">$i</a></li> ";
            }

            if($this->_noNextPrev)
                $this->components['next_link'] = ($this->currentPage != $this->totalPage && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->nextCss}\" ><a href=\"{$this->baseUrl}/$next_page\">{$this->nextText}</a></li>\n" : "<li class=\"{$this->inactiveNextCss}\"><a >{$this->nextText}</a></li>\n";
            else
                $this->output .= ($this->currentPage != $this->totalPage && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->nextCss}\"><a  href=\"{$this->baseUrl}/$next_page\">{$this->nextText}</a><li>\n" : "<li class=\"{$this->inactiveNextCss}\"><a >{$this->nextText}</a></li>\n";
        }

        $this->low = ($this->currentPage>1) ? ($this->currentPage-1) * $this->itemPerPage : 0;
